...
<div class="ui vertical stripe container">
    <div class="ui stackable grid container">
        <div class="row" style="margin-top:10vh">
            <h3 class="ui header">Calon Kandidat Pelamar</h3>
            <div class="ui segment">
                <div class="ui vertical stripe center aligned container">
                    <h2>Daftar Calon Kandidat Pelamar</h2>
                            ...
                            <tr>
                                <form id="form-<?=$res['id_pengajuan']?>" method='POST'>
                                    ...
                                    <td>
                                        ...
                                        <button class="ui teal button detail" onclick="showdetail('<?=$res['nama_lengkap']?>','<?=$res['email']?>','<?=$res['nomor_hp']?>','<?=$data['judul_lowongan']?>','<?=$res['file_cv']?>','<?=$res['file_identitas']?>','<?=$res['file_foto']?>')" >Lihat Kelengkapan</button>
                                        <button class="ui blue button" onclick="accepted(<?=$res['id_pengajuan']?>)">Terima</button>
                                        <button class="ui red button" onclick="rejected(<?=$res['id_pengajuan']?>)">Tolak</button>
                                    </td>
                            </tr>
                            <?php
                            }
